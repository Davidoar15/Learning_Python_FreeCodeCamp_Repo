## Objective: Build a User Configuration Manager that allows users to manage their settings such as theme, language, and notifications. Implement functions to add, update, delete, and view user settings.
