## Objective: Build a simple budget app that tracks spending in different categories and can show the relative spending percentage on a graph.
...
4. When a `Category` object is printed, it should:
   ...
   - Example usage and example of the output:
```
food = Category('Food')
